...
//Utilización de fetch para llamar a mi array de productos listados en el archivo JSON
...
function agregarAlCarrito(e) {
    ...
    //Aplicamos mensaje de Toastify al agregar producto al carrito
    Toastify({
        ...
        style: {
          background: "linear-gradient(to right, #0a4637, #113028)",
          borderRadius: "1rem",
